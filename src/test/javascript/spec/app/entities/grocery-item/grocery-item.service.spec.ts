...
describe('Service Tests', () => {
    describe('GroceryItem Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(GroceryItemService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/grocery-items';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a GroceryItem', () => {
                service.create(new GroceryItem(null)).subscribe(received => {
            ...
            it('should update a GroceryItem', () => {
                service.update(new GroceryItem(123)).subscribe(received => {
            ...
            it('should return a GroceryItem', () => {
